...
const SUPPORTED_MARKERS = ['its', 'coi', 'co1'];
...
const config = {
  local: {
    ...
    DATABASE_NAME: {ITS: DATABASE_NAME_ITS, COI: DATABASE_NAME_COI},
    MATCH_THRESHOLD: {ITS: MATCH_THRESHOLD_ITS, COI: MATCH_THRESHOLD_COI},
    MATCH_CLOSE_THRESHOLD: {ITS: MATCH_CLOSE_THRESHOLD, COI: MATCH_CLOSE_THRESHOLD},
